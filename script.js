const translations = {
    en: {
        ...
        "teachers.t1.desc":    "The first class that showed me what Computer Science actually is. Erick has a way of making abstract concepts click — his approach to the history and foundations of computing gave me the context I needed to understand where everything else fits.",
    ...
    pt: {
        ...
        "teachers.t1.desc":    "A primeira aula que me mostrou o que é Ciência da Computação de verdade. Erick tem uma forma de fazer conceitos abstratos fazerem sentido — sua abordagem sobre a história e os fundamentos da computação me deu o contexto que precisava para entender onde tudo se encaixa.",
